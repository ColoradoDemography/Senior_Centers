...
function init() {
	...
	dojo.byId("title").innerHTML = "Percent of Age 55+ Living Below 200% of Poverty Line";
	dojo.byId("subtitle").innerHTML = "Source: Table B17024, ACS 2008-2012 5Y : Census Tracts";
}
...
function initOperationalLayer(map) {
	...
	featureLayer = new esri.layers.FeatureLayer("https://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/PovertyComprehensive_v3/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND,
		outFields : ["*"],
		infoTemplate : infoTemplate
	});
	
	featureLayer2 = new esri.layers.FeatureLayer("https://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/PovertyComprehensive_v3/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND,
		outFields : ["*"]
	});
	
	pointLayer = new esri.layers.FeatureLayer("https://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/HousingCenter/FeatureServer/0", {
		mode : esri.layers.FeatureLayer.MODE_ONDEMAND,
		outFields : ["*"],
	...
	//for county layer
	var ptSymbol = new esri.symbol.SimpleMarkerSymbol(esri.symbol.SimpleMarkerSymbol.STYLE_CIRCLE, 28, new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new dojo.Color([250,250,250]),1), new dojo.Color([0,169,230,0.6]));
	var renderer8 = new esri.renderer.SimpleRenderer(ptSymbol);
	
	pointLayer.setRenderer(renderer8);
	...
	dojo.connect(pointLayer, "onMouseOver", function(evt) {
		map.graphics.clear();
		var highlightGraphic = new esri.Graphic(evt.graphic.geometry, new esri.symbol.SimpleMarkerSymbol(esri.symbol.SimpleMarkerSymbol.STYLE_CIRCLE, (28), new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new dojo.Color([255,0,0]),2), new dojo.Color([0,169,230,0.1])));
		map.graphics.add(highlightGraphic);
	});	
...
function getText2(graphic){
	...
	var tcontent="<table><tr><td>Building Complex:&nbsp;&nbsp;</td><td><b>"+ graphic.attributes.BUILDING_C+"</b></td></tr><tr><td>Address:&nbsp;&nbsp;</td><td><b>"+graphic.attributes.Street +", "+graphic.attributes.City+" CO</b></td></tr><tr><td>Minimum Age:&nbsp;&nbsp;</td><td><b>"+graphic.attributes.MIN_AGE+"</b></td></tr></table>";
